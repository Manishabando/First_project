...
Login spec - Login to web page using username and password,
ErrorMessage - Verify the error message if invalid login.
File upload - Upload a single file, multiple file, verify message after file uploaded.
